...
public class TencentCloudNetworkServiceImpl implements TencentCloudNetworkService {
     ...
     *
     * @param request
     * @return https://cloud.tencent.com/document/api/213/15734
     */
    @Override
    public CommonResult DescribeInstanceInternetBandwidthConfigs(DescribeInstanceInternetBandwidthConfigsRequest request) {
        try {
            DescribeInstanceInternetBandwidthConfigsResponse describeRegionsResponse = tencentConfig
                .getCvmClient()
                .DescribeInstanceInternetBandwidthConfigs(request);
     ...
     */
    @Override
    public CommonResult DescribeInternetChargeTypeConfigs() {
        try {
            DescribeInternetChargeTypeConfigsResponse describeRegionsResponse = tencentConfig
                .getCvmClient()
                .DescribeInternetChargeTypeConfigs(new DescribeInternetChargeTypeConfigsRequest());
            return CommonResult.ok(describeRegionsResponse);
        } catch (TencentCloudSDKException e) {
            e.printStackTrace();
        }
     ...
     */
    @Override
    public CommonResult InquiryPriceResetInstancesInternetMaxBandwidth(InquiryPriceResetInstancesInternetMaxBandwidthRequest request) {
        try {
            InquiryPriceResetInstancesInternetMaxBandwidthResponse describeRegionsResponse = tencentConfig
                .getCvmClient()
                .InquiryPriceResetInstancesInternetMaxBandwidth(request);
            return CommonResult.ok(describeRegionsResponse);
        } catch (TencentCloudSDKException e) {
            e.printStackTrace();
        }
     ...
     */
    @Override
    public CommonResult ResetInstancesInternetMaxBandwidth(ResetInstancesInternetMaxBandwidthRequest request) {
        try {
            ResetInstancesInternetMaxBandwidthResponse describeRegionsResponse = tencentConfig
                .getCvmClient()
                .ResetInstancesInternetMaxBandwidth(request);
            return CommonResult.ok(describeRegionsResponse);
        } catch (TencentCloudSDKException e) {
            e.printStackTrace();
        }
     ...
     */
    @Override
    public CommonResult ModifyInstancesVpcAttribute(ModifyInstancesVpcAttributeRequest request) {
        try {
            ModifyInstancesVpcAttributeResponse describeRegionsResponse = tencentConfig.getCvmClient().ModifyInstancesVpcAttribute(request);
            return CommonResult.ok(describeRegionsResponse);
        } catch (TencentCloudSDKException e) {
            e.printStackTrace();
        }
