...
public interface DescribeKeyPairsService {
     ...
     */
    CommonResult DescribeKeyPairs(List<String> keyIds, List<Filter> filters, Long offset, Long limit);
     ...
     */
    CommonResult CreateKeyPair(CreateKeyPairRequest request);
     ...
     */
    CommonResult AssociateInstancesKeyPairs(AssociateInstancesKeyPairsRequest request);
     ...
     */
    CommonResult DisassociateInstancesKeyPairs(DisassociateInstancesKeyPairsRequest request);
     ...
     */
    CommonResult DeleteKeyPairs(DeleteKeyPairsRequest request);
     ...
     */
    CommonResult ModifyKeyPairAttribute(ModifyKeyPairAttributeRequest request);
     ...
     */
    CommonResult ImportKeyPair(ImportKeyPairRequest request);
}
